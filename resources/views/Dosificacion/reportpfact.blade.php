...
<section>
	<div class="container">
		<div class="details clearfix">
			<div class="title" >Reporte Puntos de Facturación</div>
		...
		<table border="0" cellspacing="0" cellpadding="0" >
			<thead>
			<tr>
				<th class="col-6">Codigo</th>
				<th class="col-6">Alias</th>
				<th class="col-6">Sucursal</th>
			</tr>
			</thead>
			<tbody>
			@foreach($puntosfacturacion as $pf)
				<tr>
					<td class="col-6">{{$pf->codigo}}</td>
					<td class="col-6">{{$pf->alias}}</td>
					<td class="col-6">{{$pf->aliassuc}}</td>
				</tr>
			@endforeach
			</tbody>
		</table>
