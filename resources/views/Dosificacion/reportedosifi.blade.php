...
<section>
    <div class="container">
        <div class="details clearfix">
            <div class="title" >Reporte Dosificaciones</div>
        ...
        <table border="0" cellspacing="0" cellpadding="0" >
            <thead>
            <tr>
                <th class="col-6">N.Tramite</th>
                <th class="col-6">N.Autorización</th>
                <th class="col-6">N.Factura Restantes</th>
                <th class="col-6">Sistema Facturación</th>
                <th class="col-6">Fecha Limite de Emisión</th>
            </tr>
            </thead>
            <tbody>
            @foreach($dosificaciones as $d)
                <tr>
                    <td class="col-6">{{$d->ntramite}}</td>
                    <td class="col-6">{{$d->nautorizacion}}</td>
                    <td class="col-6">{{$d->stockfacturas}}</td>
                    <td class="col-6">{{$d->sistemafacturacion}}</td>
                    <td class="col-6">{{$d->fechalimiteemision}}</td>
                </tr>
                </tr>
            @endforeach
            </tbody>
