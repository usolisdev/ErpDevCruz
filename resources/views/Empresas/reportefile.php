	        ...
	        <div class="container">
	            <div class="details clearfix">
	                ...
	                <div class="data right">
	                    <div class="date">
	                        <div class="datacol"><span class="colum">Fecha: </span><span class="columdata">01/06/2014</span></div><br/>
	                        <div class="datacol"><span class="colum">Usuario: </span><span class="columdata">Isaias</span></div>
	                    </div>
	                </div>
	            </div>
