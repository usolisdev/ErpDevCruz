...
<section>
    <div class="container">
        <div class="details clearfix">
            <div class="title" >Reporte de Sucursales</div>
        ...
        <table border="0" cellspacing="0" cellpadding="0" >
            ...
            <tr>
                ...
                <th class="col-6">Contacto</th>
            </tr>
            </thead>
            <tbody>
            @foreach($sucursales as $s)
                <tr>
                    <td class="col-6">{{$s->alias}}</td>
                    <td class="col-6">{{$s->direccion}}</td>
                    <td class="col-6">{{$s->nombres}} {{$s->apellidos}}</td>
                </tr>
            @endforeach
            </tbody>
        </table>
