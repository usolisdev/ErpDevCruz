    ...
    <div data-kt-menu-trigger="click" data-kt-menu-placement="right-start" class="menu-item py-3">
        ...
        <div class="menu-sub menu-sub-dropdown w-225px px-1 py-4">
            ...
            @if($idempresa != 0)
                ...
                <div class="menu-item">
                    <a class="menu-link active" href="{{ route('listar-permisos', $idempresa) }}" title="" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right" data-bs-original-title="">
                        <span class="menu-icon">
                            <i class="las la-key fs-1"></i>
                        </span>
