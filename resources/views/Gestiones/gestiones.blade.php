...
@section('title')
	<title>Gestiones | {{$EmpresaNombre}}</title>
@endsection
...
@section('Pagetitle')
    <h1 class="text-dark fw-bolder my-1 fs-3 lh-1">Listado de Gestiones</h1>
    <!--begin::Breadcrumb-->
    <ul class="breadcrumb fw-bold fs-8 my-1">
        <li class="breadcrumb-item text-dark">Empresas</li>
        <li class="breadcrumb-item text-muted">Gestiones</li>
    </ul>
    <!--end::Breadcrumb-->
@endsection
					...
					<div class="card portlet light bordered">
						<div class="card-header border-0 pt-5">
						    <h5 class="card-title align-items-start flex-column">
						        <span class="card-label fw-bolder fs-3 mb-3">Gestion de {{$EmpresaNombre}}</span>
						    </h5>
			                <div class="">
			                	@if($access!="consulta")
			                        <button type="button" class="btn btn-primary" id="btn-addges" data-bs-toggle="modal" data-bs-target="#modaladdges">Agregar Gestion</button>
			                        <button type="button" class="btn btn-primary me-5" id="-repem" data-bs-toggle="modal" data-bs-target="#modaladddos" onclick="javascript: window.open('http://localhost:9595/ReporteFinal/Gestion.php','','width=900,height=500,left=50,top=50');">Reporte de Gestion</button>
									<button type="button" class="btn btn-warning ps-3 pe-3" id="idrtexcel">Print</button>
									<button type="button" class="btn btn-warning ps-2 pe-2" id="idrtexcel">Excel</button>
									<button type="button" class="btn  btn-danger ps-4 pe-4" onclick="javascript:window.open('http://localhost:8000/sucursales/repsucursal/{{$idempresa}}','','width=900,height=500,left=50,top=50');">PDF</button>
								@endif
							</div>
						</div>
					</div>
							...
							<div class="card portled light bordered">
								<div class="card-body py-3">
									<div id="tabla" class="table-responsive">
										<table id="tablagestiones" class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
											<thead>
			...
			<div class="modal-dialog">
				...
				<div class="modal-content">
					<div class="modal-header">
						<h3 class="modal-title" id="tituloModalges"> Crear Gestion</h3>
					...
					<div class="modal-body">
						<div class="row g-9 mb-7">
							<div class="col-md-6 fv-row">	
								<label for="txtNombreGestion" class="required fs-6 fw-bold mb-2">Nombre de la Gestion:</label>
								<input class="form-control form-control-solid" type="text" id="txtNombreGestion" name="txtNombreGestion" title="Se necesita el nombre de la Gestion" required />
							</div>
							<div class="col-md-6 fv-row">
								<label for="txtfecin" class="required fs-6 fw-bold mb-2">Fecha de Inicio:</label>
								<input class="form-control form-control-solid" type="date" id="txtfecin" name="txtfecin"  title="Se necesita una Fecha de Inicio" required />
							</div>
						</div>
						<div class="row g-9 mb-7">
							<div class="col-md-6 fv-row">
								<label for="txtfecfin" class="required fs-6 fw-bold mb-2">Fecha de Fin:</label>
								<input class="form-control form-control-solid" type="date" id="txtfecfin" name="txtfecfin" title="Se necesita una Fecha de Fin" required />
							</div>
						</div>
					</div>
