                        ...
                        _table = $('#tablapuntosfacturacion').DataTable({
                            ...
                            "columns": [
                                ...
                                { "data": "aliassuc" },
                                {
                                  ...
                                  "data": null,
                                  "defaultContent":`
                                     <a style="float: right;" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1 btn-eliminarpf" data-bs-toggle="tooltip" title="Eliminar">
                                        ...
                                        <a style="float: right;" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1 btn-godos" data-bs-toggle="tooltip" data-bs-placement="top" title="Dosificacion">
                                            <span class="svg-icon svg-icon-3">
                                          ...
                                          <a style="float: right;" title="Editar" data-bs-toggle="tooltip" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1 btn-editpf">
